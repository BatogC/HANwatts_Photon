...
void allowUser_callback(byte* payload, unsigned int length) {
    ...
    switch(retPi) {
        case 1:
            ...
            break;
        case 2:
            client.publish("HANevse1/photonConverted", "charger is free, but you already swiped the card in the last 20 sec");
            break;
        case 3:
        ...
        case 4:
            ...
            break;
        case 5:
            client.publish("HANevse1/photonConverted", "you just started a charge at this charger, but had another consecutive RFID swipe within 20 sec");
            break;
        case 6:
            client.publish("HANevse1/photonConverted", "you are already charging at another charger");
            break;
        case 7:
            client.publish("HANevse1/photonConverted", "successful RFID read, but you are not in the userlist");
            break;
        default:
            client.publish("HANevse1/photonConverted", "ERROR: unknown scenario");
   ...
   // DEBUGPORT.print("readCard>\t");
    ...
    if(Charger==1+CHARGEROFFSET)
    {
      // Look for new cards
        ...
        //publish(const char *topic, const char* payload, EMQTT_QOS qos, uint16_t *messageid = NULL);
