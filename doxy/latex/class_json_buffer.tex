\section{Json\+Buffer Class Reference}
\label{class_json_buffer}\index{Json\+Buffer@{Json\+Buffer}}


Base class for managing a static or dynamic buffer, used by both \doxyref{Json\+Parser}{p.}{class_json_parser} and \doxyref{Json\+Writer}{p.}{class_json_writer}.  
...
\item 
\textbf{ Json\+Buffer} ()
\begin{DoxyCompactList}\small\item\em Construct a \doxyref{Json\+Buffer}{p.}{class_json_buffer} object with no external buffer specified. \end{DoxyCompactList}\item 
virtual \textbf{ $\sim$\+Json\+Buffer} ()
...
\index{Json\+Buffer@{Json\+Buffer}!Json\+Buffer@{Json\+Buffer}}
\subsubsection{Json\+Buffer()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily Json\+Buffer\+::\+Json\+Buffer (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Construct a \doxyref{Json\+Buffer}{p.}{class_json_buffer} object with no external buffer specified. 
...
\begin{DoxyCode}
6                         : buffer(0), bufferLen(0), offset(0), staticBuffers(\textcolor{keyword}{false}) \{
7 
8 \}
\end{DoxyCode}
...
\begin{DoxyCode}
9                         \{
10     \textcolor{keywordflow}{if} (!staticBuffers && buffer) \{
11         free(buffer);
12     \}
13 \}
\end{DoxyCode}
...
\index{Json\+Buffer@{Json\+Buffer}!Json\+Buffer@{Json\+Buffer}}
\index{Json\+Buffer@{Json\+Buffer}!Json\+Buffer@{Json\+Buffer}}
\subsubsection{Json\+Buffer()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
Construct a \doxyref{Json\+Buffer}{p.}{class_json_buffer} with an external buffer of a given size. 
...
\begin{DoxyCode}
15                                                       : buffer(buffer), 
      bufferLen(bufferLen), offset(0), staticBuffers(\textcolor{keyword}{true}) \{
16 
17 \}
\end{DoxyCode}
...
\begin{DoxyCode}
48                                                          \{
49     \textcolor{keywordflow}{if} (!buffer || (offset + dataLen) > bufferLen) \{
50         \textcolor{comment}{// Need to allocate more space for data}
51         \textcolor{keywordflow}{if} (!allocate(offset + dataLen)) \{
52             \textcolor{keywordflow}{return} \textcolor{keyword}{false};
53         \}
54     \}
55 
56     memcpy(&buffer[offset], data, dataLen);
57     offset += dataLen;
58 
...
\begin{DoxyCode}
197 \{ \textcolor{keywordflow}{return} addData(data, strlen(data)); \}
\end{DoxyCode}
...
\begin{DoxyCode}
25                                     \{
26     \textcolor{keywordflow}{if} (!staticBuffers) \{
27         \textcolor{keywordtype}{char} *newBuffer;
28         \textcolor{keywordflow}{if} (buffer) \{
29             newBuffer = (\textcolor{keywordtype}{char} *) realloc(buffer, len);
30         \}
31         \textcolor{keywordflow}{else} \{
32             newBuffer = (\textcolor{keywordtype}{char} *) malloc(len);
33         \}
34         \textcolor{keywordflow}{if} (newBuffer) \{
35             buffer = newBuffer;
36             bufferLen = len;
...
\begin{DoxyCode}
213 \{ \textcolor{keywordflow}{return} buffer; \}
\end{DoxyCode}
...
\begin{DoxyCode}
231 \{ \textcolor{keywordflow}{return} bufferLen; \}
\end{DoxyCode}
...
\begin{DoxyCode}
218 \{ \textcolor{keywordflow}{return} offset; \}
\end{DoxyCode}
...
\begin{DoxyCode}
66                                \{
67     \textcolor{keywordflow}{if} (buffer) \{
68         \textcolor{keywordflow}{if} (offset < bufferLen) \{
69             buffer[offset] = 0;
70         \}
71         \textcolor{keywordflow}{else} \{
72             buffer[bufferLen - 1] = 0;
73         \}
74     \}
75 \}
\end{DoxyCode}
...
21     this->bufferLen = bufferLen;
22     this->staticBuffers = \textcolor{keyword}{true};
23 \}
\end{DoxyCode}
